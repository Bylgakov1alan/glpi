    ...
    public function getAllDasboardCards($force = false): array
    {
        ...
        if ($cards === null || $force) {
            ...
            $tickets_cases = [
                ...
                'escalated'          => __('Escalated to vendor'), // Добавил что бы появился новый виджет в панели с кол-вом заявок где статус равен эскалированно на вендера
            ...
            foreach ($tickets_cases as $case => $label) {
                ...
                // Дублирующая карточка для табличного представления (опционально) добавилась
